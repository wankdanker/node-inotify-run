...
var program = commander
  ...
  .option('-i, --include <glob-list>', 'List of directories to include, globstyle (minimatch)', list)
  .option('-x, --exclude <glob-list>', 'List of directories to include, globstyle (minimatch)', list)
  .on('--help', function () {
    console.log('\n  Debugging:')
